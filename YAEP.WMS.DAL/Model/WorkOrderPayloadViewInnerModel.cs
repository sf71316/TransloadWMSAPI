...
{
    internal class WorkOrderPayloadViewInnerModel : IWorkOrderPayloadViewModel
    {
        public WorkOrderPayloadViewInnerModel()
        {
            this.Labels = new List<ITicketLabelViewModel>();
        }
