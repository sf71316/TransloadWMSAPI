...
{
    internal class AllocatePlanner : AbstractAllocatePlanner, IAllocatePlanner
    {
        public AllocatePlanner(AllocatedPlannerInitParameters allocatedPlannerInitParameters)
