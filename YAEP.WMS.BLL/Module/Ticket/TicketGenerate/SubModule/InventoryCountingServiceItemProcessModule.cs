...
{
    internal class InventoryCountingServiceItemProcessModule : AbstractServiceItemProcessModule
    {
        public override Guid ServiceItemID => new Guid("4dca27fd-147e-45a4-b0a2-00e333231af6");
        public InventoryCountingServiceItemProcessModule(ServiceItemProcessModuleParameters parameters) : base(parameters)
        {
            ...
            , Guid warehouseUID, bool ForceOpen = false)
        {
            ...
            var _sequence = this.SequenceAgent.GetTicketSeqenceByTimeSerial(TicketType.InventoryCounting);
            //process Ticket
            ...
            _ticket.Type = (int)TicketInfoType.InventoryCounting;
            ...
            foreach (var item in collection)
            {
                ...
                var _itemSequence = this.SequenceAgent.GetTicketInfoSeqence(_ticket.UID);
                _info.ID = _info.Name = _itemSequence;
                _info.Type = (int)TicketInfoType.InventoryCounting;
