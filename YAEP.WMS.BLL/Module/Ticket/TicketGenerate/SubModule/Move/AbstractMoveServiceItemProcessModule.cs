...
{
    internal abstract class AbstractMoveServiceItemProcessModule : AbstractServiceItemProcessModule
    {
        public override Guid ServiceItemID => new Guid("5553ac68-1e2b-4cbe-b1bc-1af6391b8fc0");
        public AbstractMoveServiceItemProcessModule(ServiceItemProcessModuleParameters parameters) : base(parameters)
        {

        }
        public LabelType[] GetUPCEANLabel()
        {
            return new LabelType[] {
                LabelType.Box_EAN,LabelType.Box_UPC,
            ...
            , Guid warehouseUID, bool ForceOpen = false)
        {
            ...
            _ticket.Status = (int)TicketStatus.Draft;
            ...
            foreach (var item in collection)
            {
                ...
                _info.Status = (int)TicketInfoStatus.Draft;
                _info.Type = (int)TicketType.Move;
