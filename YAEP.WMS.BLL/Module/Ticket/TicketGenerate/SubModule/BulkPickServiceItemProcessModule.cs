...
{
    internal class BulkPickServiceItemProcessModule : AbstractMoveServiceItemProcessModule
    {
        public BulkPickServiceItemProcessModule(ServiceItemProcessModuleParameters parameters) : base(parameters)
        {
            ...
            , Guid warehouseUID, bool ForceOpen = false)
        {
            ...
            var _sequence = this.SequenceAgent.GetTicketSeqenceByTimeSerial( TicketType.BulkPick);
            //process Ticket
            ...
            _ticket.Type = (int)TicketType.BulkPick;
            ...
            //process Ticket Info
            var tckSeq = this.SequenceAgent.GetTicketInfoSeqenceByTimeSerial(TicketType.BulkPick, collection.Count());
            foreach (var item in collection)
            {
                ...
                _info.Type = (int)TicketInfoType.BulkPick;
