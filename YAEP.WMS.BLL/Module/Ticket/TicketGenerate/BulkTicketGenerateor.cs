...
{
    internal class BulkTicketGenerateor : AbstractTicketGenerator
    {
        public BulkTicketGenerateor(TicketGeneratorParameters parameters)
           : base(parameters)
        {
        ...
        protected override ServiceProcessItem[] ServiceItems
        {
            get
            {
                return new ServiceProcessItem[] { ServiceProcessItem.BulkPick };
            }
        }
