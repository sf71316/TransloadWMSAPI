...
{
    internal class InventoryCountingTicketGenerator : AbstractTicketGenerator
    {
        public InventoryCountingTicketGenerator(TicketGeneratorParameters parameters)
            : base(parameters)
        {
        ...
        public override ManifestType Type
        {
            get
            {
                return ManifestType.InventoryCounting;
            }
        }
        ...
        protected override ServiceProcessItem[] ServiceItems
        {
            get
            {
                return new ServiceProcessItem[] { ServiceProcessItem.InventoryCounting };
            }
        }
