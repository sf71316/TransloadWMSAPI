...
namespace YAEP.WMS.BLL.Module
{
    public class Logger : ILogInfiltrator
    {
        ...
        Exception exception = null, string ip = "", string jsonBefore = "", string jsonAfter = "", bool useLocallog = false,
        bool releaselocallogger = false)
        {
            ...
            HostingEnvironment.QueueBackgroundWorkItem(ct =>
            {
                ...
                if (useLocallog)
                {
                    ...
                    belongToRemark, application, subApplication, exception, ip, jsonBefore, jsonAfter, releaselocallogger);
                }
            });
        ...
        //public async Task LogAsync(string message, string type, string owner, string level,
        //int belongToType, string belongToUID = "", string belongToRemark = "", string application = "", string subApplication = "",
        //Exception exception = null, string ip = "", string jsonBefore = "", string jsonAfter = "", bool useLocallog = false)
        //{
        //    await Task.Run(() =>
