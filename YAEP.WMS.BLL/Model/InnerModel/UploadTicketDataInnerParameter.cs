...
{
    internal class UploadTicketDataInnerParameter : IUploadTicketDataParameter
    {
        public UploadTicketDataInnerParameter()
        {
    ...
    internal class TicketInfoParameter : ITicketInfoParameter
    {
